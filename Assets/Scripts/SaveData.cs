...
public class GameData
{
    ...
    public GameData()
    {
        ...
        keysPickedState = GameManager.keyPickedState;
        bill = GameManager.bill;
        itemsPickedState = GameManager.itemPickedState;
    ...
    public void ApplyToStatic()
    {
        ...
        GameManager.keyPickedState = keysPickedState;
        GameManager.bill = bill;
        GameManager.itemPickedState = itemsPickedState;
